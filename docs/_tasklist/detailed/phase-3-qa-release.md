...
**工数**: 24-32人日  
**進捗**: 0%（計画段階）  
**概要版**: [roadmap-phase-3.md](../roadmap-phase-3.md)（2026-02-08 更新）を参照

---

## 3.1: 本格的な QA テスト（複数人・複数周回テスト）
...
**複数テスターによる複数周回テスト**（クローズドベータテスト形式）：

```
・テスター 2-3 名を配置
・各テスターが全ステージを独立してプレイ（複数周回）
・異なるプレイスタイル（急速クリア、丁寧なプレイ等）で実施
・Development Build でログ収集
・各ステージで進行可能性・バグ・パフォーマンスを記録
```
...
**最終更新**: 2026-02-08
**ステータス**: 計画段階（新 Phase 3 構成に対応済み）  
**備考**: このドキュメントは [roadmap-phase-3.md](../roadmap-phase-3.md) の詳細実装計画です
