...
public class UnitNPCact : MonoBehaviour
{
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        if (hit.gameObject.tag == GameEnum.EnemyType.Garbage.ToString())
        {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.tag == GameEnum.EnemyType.Garbage.ToString())
        {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == GameEnum.EnemyType.Garbage.ToString())
        {
