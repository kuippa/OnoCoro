...
namespace CommonsUtility
{
    ...
    internal static class YamlCommandManager
    {
        ...
        private const string _MSG_INVALID_EVENT_TYPE = "不正な YamlEventType: {0}（実装済みのイベント型: spawn_unit, spawn_enemy_unit, weather, solar, wind, watersurface, ocean, swell, earthquake, building_break, notice, telop, subtelop, bloom_path, off_bloom_path, off_bloom_path_complete, bloom_sakura, volcano）";
