...
public class ItemCreateCtrl : MonoBehaviour
{
	...
	{
		_btnClose = base.transform.Find("CreateWindow/titlebar/btnClose").GetComponent<Button>();
		if (_btnClose != null)
		{
		...
		_btnOK = base.transform.Find("CreateWindow/footer/btnOK").GetComponent<Button>();
		if (_btnOK != null)
		{
		...
		_btnCreate = base.transform.Find("CreateWindow/mainarea/pnlMain/btnCreate").GetComponent<Button>();
		if (_btnCreate != null)
		{
		...
		_gauge = base.transform.Find("CreateWindow/mainarea/pnlMain/timeGauge/timeGaugeFill").GetComponent<Image>();
		if (_gauge != null)
		{
			_ = _gauge;
			ResetGauge();
		...
		_btnLeft = base.transform.Find("CreateWindow/mainarea/pnlLeft/btnLeft").GetComponent<Button>();
		_btnRight = base.transform.Find("CreateWindow/mainarea/pnlRight/btnRight").GetComponent<Button>();
	...
	{
		if (base.gameObject.AddComponent(type) is IItemStructProvider itemStructProvider)
		{
	...
	{
		GameObject gameObject = base.transform.Find("CreateWindow/mainarea/pnlMain").gameObject;
	...
	{
		Button componentInChildren = base.transform.Find("CreateWindow/mainarea/pnlLeft").gameObject.GetComponentInChildren<Button>();
		Button componentInChildren2 = base.transform.Find("CreateWindow/mainarea/pnlRight").gameObject.GetComponentInChildren<Button>();
	...
	private void CreateComplete()
	{
		...
		base.gameObject.transform.parent.gameObject.GetComponentInChildren<ItemListCtrl>().SetItemStruct(_itemList[_page]);
	}
